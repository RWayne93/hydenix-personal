  ...
  # FOLLOW THE BELOW INSTRUCTIONS LINE BY LINE TO SET UP YOUR SYSTEM
{
  ...
  hydenix = {
    ...
    hostname = "nixie"; # REQUIRED: Set your computer's network name (change to something unique)
    timezone = "America/New_York"; # REQUIRED: Set timezone (examples: "America/New_York", "Europe/London", "Asia/Tokyo")
...
#    hm.enable = true;
  ...
  # Enable Flatpak for writable Spotify installs (required for Spicetify theming).
